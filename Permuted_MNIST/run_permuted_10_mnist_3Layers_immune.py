...
alpha = 1.0
# Layer1
w1, force_layer1 = get_layer([28*28, 800], alpha=alpha, args=args)
b1 = get_bias(w1.size(1))
# Layer2
w2, force_layer2 = get_layer([800, 800], alpha=alpha, args=args)
b2 = get_bias(w2.size(1))
# Layer_out
w3, force_layer3 = get_layer([800, class_num], alpha=alpha, args=args)
