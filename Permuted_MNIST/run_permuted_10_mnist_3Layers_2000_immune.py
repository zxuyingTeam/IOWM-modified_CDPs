...
parser.add_argument('--lr_initial', type=float, default=0.6)
parser.add_argument('--class_num', type=int, default=10)
parser.add_argument('--num_epochs', type=int, default=20)
parser.add_argument('--batch_size', type=int, default=100)
parser.add_argument('--seed_num', type=int, default=30)
parser.add_argument('--immune_r', type=int, default=10, help="the radius of trust region")
...
for task_index in range(Task_num):
    learning_rate = lr_initial + 0.1 * task_index
    loss_all = []
    ss = np.arange(28*28)
    if task_index > 0:
        np.random.seed(task_index)
