...
os.environ["CUDA_VISIBLE_DEVICES"] = "2"  # use gpu
...
batch_size = 100
learning_rate = 2.0   # amount of each extract
...
alpha = 1.0
# Layer1
w1, force_layer1 = get_layer([28*28, 2000], alpha=alpha)
b1 = get_bias(w1.size(1))
# Layer2
w2, force_layer2 = get_layer([2000, 2000], alpha=alpha)
b2 = get_bias(w2.size(1))
# Layer_out
# Layer_out
w3, force_layer3 = get_layer([2000, class_num], alpha=alpha)
relu = nn.ReLU().cuda()
