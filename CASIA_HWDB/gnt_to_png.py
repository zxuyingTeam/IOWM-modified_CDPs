...
for image, tagcode in read_from_gnt_dir(gnt_dir=train_data_dir):
    ...
    dir_name = './data/chinese_hand_write/train/' + '%0.5d' % char_dict[tagcode_unicode]
...
for image, tagcode in read_from_gnt_dir(gnt_dir=test_data_dir):
    ...
    dir_name = './data/chinese_hand_write/test/' + '%0.5d' % char_dict[tagcode_unicode]
    if not os.path.exists(dir_name):
        os.mkdir(dir_name)
