...
import immune_owm_3Layer as approach
...
# num_epochs = 20
lr = 0.2
appr = approach.Appr(net, sbatch=batch_size, lr=lr, input_size=784, hidden1=800, hidden2=800)
print('-'*100)
...
for t, ncla in taskcla:
    ...
    if t == 0:
        ...
        num = 1
    # Train
    appr.train(t, xtrain, ytrain, xvalid, yvalid, data, num_epochs, nums=num)
    print('-'*100)
